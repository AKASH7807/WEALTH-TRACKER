...
import {Wallet, Tag, Repeat} from "lucide-react"; // Import icons
...
export function AddTransactionForm({
    ...
    const {
        ...
        defaultValues: editMode && initialData ? {
            ...
            // Date is set in useEffect to avoid hydration mismatch
            date: undefined,
            isRecurring: false
        }
    });
    ...
    // Set default date on mount for new transactions
    useEffect(() => {
    ...
    return (
                            ...
                            ({field}) => (
                                <Select onValueChange={
                                    ...
                                    <SelectContent> {
                                        ...
                                        <CreateAccountDrawer>
                                            <Button variant="ghost" className="w-full text-sm rounded-md hover:bg-indigo-50">
                                                Create Account
                                            </Button>
                                        </CreateAccountDrawer>
                                    </SelectContent>
                    ...
                    <Popover>
                        <PopoverTrigger asChild>
                            <Button variant="outline"
                                className={
                                    cn("w-full pl-3 text-left font-normal", ! date && "text-muted-foreground")
                            }>
                                {
        ...
        isRecurring && (
            <div className="space-y-2">
                ...
                <Controller name="recurringInterval"
                    control={control}
                    render={
                        ({field}) => (
                            <Select onValueChange={
